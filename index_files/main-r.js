var reactVersions = {
  ...
  "components": "1.428.10",
  "core": "1.428.10",
  "editingRendererPlugins": "1.428.10",
  "fonts": "1.428.10",
  "layout": "1.428.10",
  "qaAutomation": "1.428.10",
  "skins": "1.428.10",
  "testUtils": "1.428.10",
  "tpa": "1.428.10",
  "utils": "1.428.10",
  "wixSites": "1.428.10",
  "wixappsBuilder": "1.428.10",
  "wixappsClassics": "1.428.10",
  "wixappsCore": "1.428.10"
};
...
function wixRenderSite() {
    ...
    function prefetchPages() {
        var isHttps = typeof document !== "undefined" && document.location.protocol === "https:";
        if (isHttps) {
    ...
    if (window.publicModel){
        prefetchPages();
    }

    function convertRendererModel(oldRendererModel, _publicModel) {
    ...
    var serviceURL = joinURL.bind(null, staticServerUrl);
    var config = {
        baseUrl: '/',
        paths: {
            modernizr: serviceURL('services/third-party/modernizer/2.6.2/modernizr-2.6.2.min'),
            lodash: getLodashPath({production: serviceURL('services/third-party/lodash/2.4.1/dist/lodash.min'), ios8: 'js/vendor/lodash/lodash-custom-ios8.min'}),
            ...
            TweenMax: {min: serviceURL('services/third-party/tweenmax/1.15.0/minified/TweenMax.min'), source: serviceURL('services/third-party/tweenmax/1.15.0/uncompressed/TweenMax')},
            TimelineMax: {min: serviceURL('services/third-party/tweenmax/1.15.0/minified/TweenMax.min'), source: serviceURL('services/third-party/tweenmax/1.15.0/uncompressed/TweenMax')},
            ScrollToPlugin: {min: serviceURL('services/third-party/tweenmax/1.15.0/minified/plugins/ScrollToPlugin.min'), source: serviceURL('services/third-party/tweenmax/1.15.0/uncompressed/plugins/ScrollToPlugin')},
            skins: 'js/skins',
...
////////////////////////////////////////////////////////////////////////
    ...
    requirejs.config({
        ...
        shim: {
            ...
            jjv: { exports: 'jjv' },
            layout: { deps: ['react', 'lodash', 'zepto'] }
        },
        waitSeconds: 0
    });
...
(function () {
    ...
    function isOptimizedForMobileSite() {
        return window.publicModel && window.publicModel.adaptiveMobileOn;
    }
